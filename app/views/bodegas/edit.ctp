...
<?php echo $form->create('Bodega');?>
	<fieldset>
 		<legend><?php __('Edit Bodega');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Bodega.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Bodega.id'))); ?></li>
